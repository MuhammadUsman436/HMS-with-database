...
alter table appointment add constraint Doc_fk foreign key (doctorid) references doctors(id);
alter table appointment add constraint Patient_fk foreign key (patient_id) references tblpatient(ID);

alter table doctors add constraint special_IDfk foreign key(Speciallist_ID) references doctorspecilization(id);

alter table tblmedicalhistory add constraint Patient_IDfk foreign key(PatientID) references tblpatient(ID);



alter table doctors add column Speciallist_ID int;
